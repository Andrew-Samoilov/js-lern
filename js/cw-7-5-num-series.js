...
function add(x, y) {
    ...
    let templXArr = [] = String(x).split('');
    console.log(`templXArr`, templXArr);
    let templYArr = [] = String(y).split('');
    console.log(`templYArr`, templYArr);
    console.log(`x%y`, x % y);
    for (let i = 0; i < templYArr.length; i++) {
        const element = templYArr[i];
        console.log(element)
    }
    return 2;
}

console.log(add(12, 35), 47);
